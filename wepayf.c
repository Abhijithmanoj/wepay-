    ...
    if (j==1)
    {
        while(c=='y'||c=='Y')
        {
            ...
            while(fread(&stud,sizeof(stud),1,fs)==1)
            {
                if (adm==stud.r)
                {
                    printf("Admission number Already exsist, Enter new admission number\n");
                    admno();
                }
            }
    ...
    if (j==1)
    {
        while(c=='y'||c=='Y')
        {
            ...
            else if (choice==2)
            {
                int rll;
                a=1;
                printf("\n\nEnter Adm No of student to search: ");
                fflush(stdin);
                scanf("%d",&no);
                //rll=clscanf();
                fs=fopen("student","rb");
...
void modrec(int j)
{
    ...
    if (j==1)
    {
        while(c=='y'||c=='Y')
        {
            ...
            printf("\n\n\t\t1::Modify by name,class & admission no::");
            printf("\n\n\t\t2::Exit");
            printf("\n\n\t\t::Enter your choice:: ");
            fflush(stdin);
            scanf("%d",&choice);
            if (choice==1)
            {
                ...
                fflush(stdin);
                cl=clscanf();
                printf("\n\nenter adm no of student to modify: ");
                fflush(stdin);
                scanf("%d",&rolno);
                fs=fopen("student","rb+");
                while(fread(&stud,sizeof(stud),1,fs)==1)
